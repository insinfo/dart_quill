...
class OperateLine {
  ...
  updateCell(node: Element) {
    ...
    const handleMouseup = (e: MouseEvent) => {
      ...
      // SALI: o resize acima altera o DOM diretamente (setCellRect/setCellsRect
      // via setElementAttribute), mas o Delta cacheado do Quill nao e
      // invalidado, entao getContents() devolveria larguras congeladas. Forca
      // o Quill a re-sincronizar o modelo a partir do DOM, como o proprio
      // plugin ja faz em outras operacoes (quill-table-better.ts).

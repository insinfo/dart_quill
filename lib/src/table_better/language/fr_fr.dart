/// Port of quill-table-better `src/language/fr_FR.ts` (v1.2.3).
const Map<String, String> frFR = {
  ...
  'cancel': 'Annuler',
  'colorMsg':
      'La couleur est invalide. Essayez "#FF0000" ou "rgb(255,0,0)" ou "rouge".',
  'dimsMsg':
      'La valeur est invalide. Essayez "10px" ou "2em" ou "2%" ou simplement "2".',

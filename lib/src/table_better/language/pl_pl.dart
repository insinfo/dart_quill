/// Port of quill-table-better `src/language/pl_PL.ts` (v1.2.3).
const Map<String, String> plPL = {
  ...
  'cancel': 'Anuluj',
  'colorMsg':
      'Kolor jest nieprawidłowy. Spróbuj "#FF0000" lub "rgb(255,0,0)" lub "red".',
  'dimsMsg':
      'Wartość jest nieprawidłowa. Spróbuj "10px" lub "2em" lub "2%" lub po prostu "2".',

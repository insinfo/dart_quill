/// Port of quill-table-better `src/language/de_DE.ts` (v1.2.3).
const Map<String, String> deDE = {
  ...
  'cancel': 'Abbrechen',
  'colorMsg':
      'Die Farbe ist ungültig. Probiere "#FF0000", "rgb(255,0,0)" oder "red".',
  'dimsMsg':
      'Der Wert ist ungültig. Probiere "10px", "2em" oder "2%" oder einfach "2".',

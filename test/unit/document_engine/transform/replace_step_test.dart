...
void main() {
  group('ReplaceAroundStep.map', () {
    void testMap(PMNode docNode, void Function(Transform tr) change,
        void Function(Transform tr) otherChange, PMNode expected) {
    ...
    test('doesn\'t break wrap steps on insertions', () {
      testMap(
          ...
          (tr) => tr.wrap(tr.doc.resolve(1).blockRange()!,
              [Wrapping(testSchema.nodes['blockquote']!)]),
          (tr) => tr.insert(0, p("b")),

...
- [ ] G7.4 **`tool/gen_icons.dart` — embutimento gerado dos SVGs.** Contraparte do
...
- [ ] G7.5 **Estender o gerador ao table-better**: `lib/src/table_better/assets/icons.dart`
...
- [ ] G7.6 **Teste de regressão do gerado**: um teste que re-executa a geração em memória e

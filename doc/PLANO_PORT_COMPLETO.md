...
**Incremento seguinte:** núcleo do módulo `TableBetter`, caminho delta→DOM e bindings de célula cobertos; estado atual: 231 unitários + 3 E2E + 7 browser no Chrome.

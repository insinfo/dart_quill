...
| Fonte de ícones com cobertura para as fases seguintes | ✅ | 116 ícones (era 35) gerados de `resources/onlyoffice_ribbon_icons` por `tool/build_icon_css.dart` (2026-08-09): bordas, disposição de texto, cabeçalho/rodapé, colunas, hifenização, numeração de linhas, marca-d'água, alinhamento de tabela e busca |
